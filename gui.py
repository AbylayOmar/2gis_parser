...
MAX_N_SHOW_ITEM = 300
HISTORY_FILE_PATH = os.path.expanduser('~') + "/.2GISparser_history"
MAX_HISTORY = 10
...
def main():
    ...
    app = GUI(root, json_path=args.file, initial_dir=args.dir)
